import {
  ...
  import { fetchAllGenre } from "../../apis/genreApi";
...
const ShowAllGenre = ({success}) => {
  ...
  // call api get all genre
  useEffect(() => {
    fetchAllGenre(jwt, page, rowsPerPage, title, direction).then(
      (response) => {
  ...
  const handleUpdate = (value) => {
    navigate(`/genre/update/${value.id}`, { state: { data: value } });
  };
