...
const ShowAllCountry = ({success}) => {
  ...
  // call api get all Country
  useEffect(() => {
    fetchAllCountry(jwt, page, rowsPerPage, title, direction).then(
      (response) => {
  ...
  const handleUpdate = (value) => {
    navigate(`/country/update/${value.id}`, { state: { data: value } });
  };
